...
public class fontFrame extends JFrame {
	...
	public fontFrame(){
		...
		size  = new JComboBox<>(new Integer[]{10,12,15,18,24,36});
		...
		add(bold,new GBC(0,2,2,1).setAnchor(GBC.CENTER).setWeight(0, 0));
		add(italic,new GBC(0,3,2,1).setAnchor(GBC.CENTER).setWeight(0, 0));
